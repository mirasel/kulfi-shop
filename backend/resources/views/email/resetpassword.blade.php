                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            ...
                                            {{ config('auth.passwords.users.expire') }} minutes.</p>
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                                ...
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        into your web browser: <a
                                                            href="{{ $url }}?email={{ $email }}"
                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3869d4;">{{ $url }}?email={{ $email }}</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
